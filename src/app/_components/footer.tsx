...
export function Footer() {
  return (
    <footer className="bg-neutral-50 border-t border-neutral-200 dark:bg-black dark:border-t dark:border-gray-800">
      <Container>
        <div className="py-28 flex flex-col lg:flex-row items-center">
          <h3 className="text-4xl lg:text-[2.5rem] font-bold tracking-tighter leading-tight text-center lg:text-left mb-10 lg:mb-0 lg:pr-4 lg:w-1/2">
            Punjipati Finance.
            <br />
            <span className="text-xl text-gray-600 dark:text-gray-300 font-normal">
        ...
        <div className="border-t border-neutral-200 dark:border-gray-800 py-8 text-center">
          <div className="flex items-center justify-center gap-4 mb-4">
            <a
              href="https://www.instagram.com/punjipati/"
              target="_blank"
          ...
          <p className="text-gray-600 dark:text-gray-300">Punjipati</p>
        </div>
      </Container>
    </footer>
  );
